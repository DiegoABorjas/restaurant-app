...
return (
    <>
    <footer className="dark:bg-gray-800 m-0 bg-gray-500">
  <div className="text-center w-full max-w-screen-xl mx-auto p-4 md:py-8">
      <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <ul className="flex justify-center flex-wrap items-center mb-6 text-sm font-medium text-white sm:mb-0">
              <li>
      ...
      <span className="block text-sm text-white sm:text-center dark:text-white"> <a href="https://diegoborjas.netlify.app/" target="_blank" className="hover:underline">&copy; 2023 DB</a>. All Rights Reserved.</span>
  </div>
</footer>
